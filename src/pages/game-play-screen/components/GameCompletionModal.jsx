...
const GameCompletionModal = ({ 
  ...
  // Save results and navigate to full screen results
  const handleViewResults = () => {
    const gameResults = {
      playerName: "Player",
      playerEmail: localStorage.getItem('playerEmail') || "player@example.com",
      finalScore,
      totalBubbles: totalSkills,
      correctPlacements,
      incorrectPlacements: totalSkills - correctPlacements,
      timeTaken: Math.floor((180 - timeRemaining)),
      gameStartTime: new Date(Date.now() - ((180 - timeRemaining) * 1000)),
      gameEndTime: new Date(),
      skillCategories: ["Technical", "Creative", "Leadership", "Communication", "Analytical"],
      gameData: {
        playerEmail: localStorage.getItem('playerEmail') || "player@example.com",
        gameStartTime: new Date(Date.now() - ((180 - timeRemaining) * 1000)),
        gameEndTime: new Date(),
    ...
    localStorage.setItem('skillBucketGameResults', JSON.stringify(gameResults));
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Button
                  variant="ghost"
                  onClick={() => navigate('/email-entry-screen')}
                  iconName="Home"
                  iconPosition="left"
                  className="hover-lift py-3"
                >
